...
let ville = "Toulouse"; //une ville par defaut 
recevoirTemperature(ville); //on commence pour appeler la fonction pour avoir une ville par defaut

const changer     = document.querySelector('#changer');  
//const temperature = document.querySelector('#temperature_label'); pourquoi on peut pas faire ça?
